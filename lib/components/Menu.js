...
const menuRightItems = [
  { text: '', link: '/login', icon: 'fa fa-user' },
]
    ...
    <nav id="menu" className="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div className="container">
        <div className="navbar-header">
          ...
          <Link to="/" className="navbar-brand" activeClassName='active'>Baqend <i className="fa fa-heart"></i> CoreMedia</Link>
        </div>
        <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul className="nav navbar-nav navbar-right">
            ...
            <MenuListItem text="Logout" activeClassName='active' link="/logout" icon="fa fa-sign-out"/>
            }
